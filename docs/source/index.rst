...
| You can find the code at `<https://github.com/fabienlacasa/PySSC>`_
...
| See the :doc:`bibliography` section to find additional dependencies to cite if you use the code.
